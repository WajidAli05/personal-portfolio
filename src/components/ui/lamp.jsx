...
export function LampDemo({ text }) {
  return (
    <LampContainer>
        ...
        className="mt-8 text-white text-center text-4xl font-medium tracking-tight md:text-7xl"
        >
        {text}
        </motion.h1>
    </LampContainer>
  ...
  return (
    <div
      ...
      <div
        ...
        <div
          className="absolute top-1/2 h-10 w-full translate-y-12 scale-x-150 bg-slate-950 blur-2xl"></div>
        <div
